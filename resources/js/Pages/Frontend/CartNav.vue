                    ...
                    <div class="h-full flex flex-col bg-white shadow-xl">
                        <div class="flex-1 py-6 overflow-y-auto px-4 sm:px-6">
                            <div class="flex items-start justify-between">
                                <h2
                                    class="text-lg text-heading font-bold text-gray-900"
                                    id="slide-over-title"
                                >
                                    Cart
                                </h2>
                                <div class="ml-3 h-7 flex items-center">
                                    <button
                                        ...
                                        @click="clear"
                                        class="bg-transparent bg-red-500 hover:bg-red-800 text-white font-bold py-1 px-2 rounded-md"
                                    >
                                        Clear Cart
                                    </button>
                                    <button
                                        v-on:click="
                                            (show = false), this.$emit('close')
                                        "
                                        type="button"
                            ...
                            <div class="mt-8">
                                ...
                                >
                                    ...
                                    <h3
                                        class="text-lg text-heading font-bold pt-8"
                                    >
                                        Your Cart Is Empty.
                                    </h3>
                                </div>
